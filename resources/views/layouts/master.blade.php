		...
		<div class="container">
				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							...
							<li>
								<a href="{{ asset('frontend/') }}contact.html">Contact Us</a>
							</li>
							<li>
								<a href="{{ asset('frontend/') }}help.html">Help</a>
							</li>
							<li>
								<a href="{{ asset('frontend/') }}faqs.html">Faqs</a>
							</li>
							<li>
								<a href="{{ asset('frontend/') }}terms.html">Terms of use</a>
							</li>
							<li>
								<a href="{{ asset('frontend/') }}privacy.html">Privacy Policy</a>
							</li>
						</ul>
					</div>
					<div class="col-xs-6 footer-grids">
			...
			<div class="agile-sometext">
				...
				<div class="sub-some">
					...
					<ul>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Aashirvaad</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Amul</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Bingo</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Boost</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Durex</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html"> Maggi</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Glucon-D</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Horlicks</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Head & Shoulders</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Dove</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Dettol</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Dabur</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Colgate</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Coca-Cola</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Closeup</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html"> Cinthol</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Cadbury</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Bru</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Bournvita</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Tang</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Pears</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Oreo</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html"> Taj Mahal</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Sprite</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Thums Up</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Fair & Lovely</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Lakme</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Tata</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Sunfeast</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html">Sunsilk</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Patanjali</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">MTR</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product.html">Kissan</a>
						</li>
						<li>
							<a href="{{ asset('frontend/') }}product2.html"> Lipton</a>
						</li>
					</ul>
				</div>
				<!-- //brands -->
